...
export const CoreFeaturesSection = (): JSX.Element => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Get a clear picture of what's in your herbs. Borderless breaks down each plant's active compounds by type and percentage, no lab needed.",
      image: "/figmaAssets/image.png",
      bg: "/figmaAssets/rectangle-35.png",
      color: "#4b533e",
    },
    {
      id: "pharma-comparison",
  ...
  // move to the next feature on click — loop back at end
  const goToNext = () => {
      ...
      <div className="relative w-full h-[568px]">
        {features.map((feature, index) => {
          ...
          return (
            ...
            >
              <Card
                className="w-full h-full border-none rounded-[16px] overflow-hidden cursor-pointer"
                // CLICK = next slide
                onClick={goToNext}
              >
                <CardContent className="p-0 relative w-full h-full">
                  ...
                  <div className="absolute top-[230px] left-[80px] right-[80px] bottom-[80px] flex items-center justify-between pointer-events-none">
                    <div className="flex flex-col max-w-[380px] items-start gap-6">
                      <h3
                        className="text-4xl font-bold leading-tight"
                        style={{ color: feature.color }}
