...
export const TestimonialsSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-10 w-full px-[140px] mt-60">
      <h2 className="font-brand-h2 font-[number:var(--brand-h2-font-weight)] text-[#07130e] text-[length:var(--brand-h2-font-size)] text-center tracking-[var(--brand-h2-letter-spacing)] leading-[var(--brand-h2-line-height)] [font-style:var(--brand-h2-font-style)] mb-5">
        What Users Say
      </h2>
      ...
      <div className="w-full">
        <div className="flex items-center justify-center gap-8 w-full">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="w-[352px] h-[291px] bg-[#daece3] rounded-2xl overflow-hidden border-none"
            >
              <CardContent className="p-12 flex flex-col justify-between h-full">
                <p className="[font-family:'Maison_Neue-BookItalic',Helvetica] font-normal italic text-[#07130e]/90 text-base leading-[22px]">
                  {testimonial.quote}
                </p>
                ...
                <div className="flex items-center gap-5 mt-6">
                  ...
                  <div className="font-brand-body-med font-[number:var(--brand-body-med-font-weight)] tracking-[var(--brand-body-med-letter-spacing)] leading-[var(--brand-body-med-line-height)] [font-style:var(--brand-body-med-font-style)] text-[length:var(--brand-body-med-font-size)]">
                    ...
                    <span className="text-[#4b5a56]/80 block">
                      {testimonial.title}
                    </span>
                  </div>
                </div>
